...
enum class TicketStatus {
    Purchased            = 0,  // bilet aktywny (kupiony)
    RefundRequested      = 1,  // klient poprosił o zwrot (czeka na decyzję admina)
    Refunded             = 2,  // admin zaakceptował zwrot (pieniądze oddane, miejsce zwolnione)
    RefundRejected       = 3   // admin odrzucił zwrot
};
